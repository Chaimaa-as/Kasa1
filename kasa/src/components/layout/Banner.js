...
// 6. `</section>` : Ferme la balise `section`.

// 7. `export default Banner;` : Exporte le composant "Banner" comme export par défaut du module,
// ce qui permet d'importer et d'utiliser ce composant dans d'autres fichiers du projet.
