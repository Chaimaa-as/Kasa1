...
// 1. Cette ligne importe un fichier de styles SCSS
// (un langage de préprocesseur CSS) et l'applique aux composants React.
import "./scss/styles.scss";

// 2. Ici, on importe la bibliothèque React pour pouvoir
// utiliser ses fonctionnalités dans ce fichier.
import React from "react";

// 3. On importe le package ReactDOM, qui fournit des méthodes spécifiques
// au DOM (Document Object Model) pour manipuler le rendu des composants React.
import ReactDOM from "react-dom/client";

// 4. On importe le composant principal de l'application, généralement
// appelé `App`, depuis le fichier `App.js`.
import App from "./App";

// 5. Cette ligne importe une fonction pour mesurer les performances
// de l'application en utilisant des Web Vitals
// (métriques pour la performance et la qualité d'une page web).
import reportWebVitals from "./reportWebVitals";

// 6. On crée un "root" pour notre application React en utilisant la méthode `createRoot()`.
